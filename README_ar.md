...
## تثبيت Plugin OpenPencil واختباره

هذا مثال بإصدار ثابت من الصفحة المرجعية. أوقف Web UI وتأكد من نجاح `op --version`، ثم استخدم إصدار DSH نفسه للتثبيت والفحص والتشغيل والإزالة.
...
اطلب في Session جديدة إنشاء مستند `.op` وفحصه. قبل الإنتاج، راجع الناشر والصلاحيات والتوافق، واستبدل `@latest` بإصدار دقيق تم اختباره. للإزالة أوقف الواجهة وشغّل `dsh plugin --profile web remove @zseven-w/dsh-openpencil`. تتوفر إرشادات التطوير والتشخيص والأمان الكاملة [بالإنجليزية](README.md#install-and-use-a-dsh-plugin-openpencil-example) و[بالصينية](README_zh.md#安装与使用-dsh-pluginopenpencil-示例).
...
## واجهات نماذج flaq.ai وبرنامج التسويق بالعمولة

[flaq.ai](https://flaq.ai/) منصة خارجية لتجميع نماذج الذكاء الاصطناعي وتقديم API. عند بناء Agent على DSH يمكن تقييم [DeepSeek V4 Pro Text-to-Text](https://flaq.ai/models/deepseek/deepseek-v4-pro-text-to-text/) للاستدلال والكتابة والبرمجة والتحليل، و[DeepSeek V4 Flash Text-to-Text](https://flaq.ai/models/deepseek/deepseek-v4-flash-text-to-text/) للتوليد والتلخيص والأتمتة السريعة والمهتمة بالتكلفة. قبل الدمج تحقق من معرف النموذج والبث واستدعاء الأدوات والأسعار ومعالجة البيانات والأخطاء. هذا ليس ضماناً للتوافر أو التوافق.

يمكن للمطورين وصناع المحتوى التقدم إلى [برنامج flaq.ai للتسويق بالعمولة](https://flaq.ai/affiliate-agreement/). تخضع المشاركة للاتفاق الحالي والقانون ومتطلبات الإفصاح، ولا يوجد ضمان للزيارات أو العمولة أو الدفع أو الأرباح.
