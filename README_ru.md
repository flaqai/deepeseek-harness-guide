...
## Установка и проверка Plugin OpenPencil

Это пример с зафиксированной версией со страницы-источника. Остановите Web UI, проверьте `op --version` и используйте одну версию DSH для установки, проверки, запуска и удаления.
...
В новой Session запросите создание и проверку документа `.op`. Перед production проверьте издателя, разрешения и совместимость, замените `@latest` точной протестированной версией. Для удаления остановите UI и выполните `dsh plugin --profile web remove @zseven-w/dsh-openpencil`. Полные инструкции по разработке, диагностике и безопасности доступны на [английском](README.md#install-and-use-a-dsh-plugin-openpencil-example) и [китайском](README_zh.md#安装与使用-dsh-pluginopenpencil-示例).
...
## API моделей flaq.ai и партнёрская программа

[flaq.ai](https://flaq.ai/) — сторонняя платформа агрегации моделей и AI API. Для Agent на DSH можно оценить [DeepSeek V4 Pro Text-to-Text](https://flaq.ai/models/deepseek/deepseek-v4-pro-text-to-text/) для рассуждений, текста, кода и анализа и [DeepSeek V4 Flash Text-to-Text](https://flaq.ai/models/deepseek/deepseek-v4-flash-text-to-text/) для быстрой и экономичной генерации, сводок и автоматизации. Перед интеграцией проверьте актуальные ID, streaming, tool calling, цены, обработку данных и ошибки. Это не гарантия доступности или совместимости.

Разработчики и авторы могут подать заявку в [партнёрскую программу flaq.ai](https://flaq.ai/affiliate-agreement/). Действуют текущие условия, законы и требования раскрытия; трафик, комиссия, выплата или доход не гарантируются.
